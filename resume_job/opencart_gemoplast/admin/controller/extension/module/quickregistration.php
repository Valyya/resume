<?php
class ControllerExtensionModuleQuickRegistration extends Controller {
	protected $extension = 'registration';
	protected $error = array();

        public function index() {
		$this->load->language('extension/module/quickregistration');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			if (!isset($this->request->get['continue'])) {
				...
				$this->response->redirect($this->url->link('extension/module/quickregistration', 'token=' . $this->session->data['token'] . '&store_id=' . $store_id, true));
			}
		}
		...
		$setting = $this->model_setting_setting->getSetting('quickregistration', $store_id);
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/quickregistration', 'token=' . $this->session->data['token'], true)
   		);

                $data['action'] = $this->url->link('extension/module/quickregistration', 'token=' . $this->session->data['token'] . '&store_id=' . $store_id, true);
                $data['continue'] = $this->url->link('extension/module/quickregistration', 'token=' . $this->session->data['token'] . '&continue=1&store_id=' . $store_id, true);
		...
		$data['footer'] = $this->load->controller('common/footer');
        	...
        	$this->response->setOutput($this->load->view('extension/module/quickregistration', $data));
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/quickregistration')) {
