      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="fax" value="<?php echo $fax; ?>" placeholder="<?php echo $entry_fax; ?>" id="input-fax" class="form-control" style="display:none" />
        ...
        <fieldset id="address">
          <h2 class="secondary-title"><?php echo $text_your_address; ?></h2>
              ...
              <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control" style="display:none" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="form-control" style="display:none" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control" style="display:none" />
              ...
              <select name="zone_id" id="input-zone" class="form-control" style="display:none">
              </select>
              <?php if ($error_zone) { ?>
        ...
        <div class="buttons">
          <div class="pull-right"><?php echo $text_agree; ?>
            ...
            &nbsp;
            <input type="submit" value="<?php echo empty($proceed_button_text) ? $button_continue : $proceed_button_text; ?>" class="btn btn-primary" />
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons">
