      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="thumbnails product-page-image">
            ...
            <li class="image-additional col-xs-4"><a class="thumbnail" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
            <?php } ?>
            <?php } ?>
            </div>
          </ul>
          ...
          <div id="product">
           ...
           <label class="control-label " for="input-quantity"><?php echo $entry_qty; ?></label>
            ...
            <div class="col-xs-6 col-sm-4">
             ...
             <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary larg"><i class="fa fa-shopping-cart"></i><span class="hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
           </div>
