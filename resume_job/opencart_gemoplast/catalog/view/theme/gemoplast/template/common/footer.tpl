    ...
    <div class="container">
        <div class="row">
            ...
            <nav class="nav-social">
                <ul>
                    <li><a href="http://facebook.com" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a>
                    </li>
...
<div id="callback" class="callback-form product-popup">
        ...
        <p>Введите номер телефона и наш менеджер <strong>перезвонит</strong>  Вам</p>
<form class="ajax-form">
		<!-- Hidden Required Fields -->
		<input type="hidden" name="project_name" value="Gemoplast">
		<input type="hidden" name="admin_email" value="weblettop@gmail.com">
		<input type="hidden" name="form_subject" value="Заявка с сайта Gemoplast">
